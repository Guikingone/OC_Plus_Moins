...
int main()
{
    ...
    if(choixJoueur != 0){
        ...
        // On initialise ici le nombreMystere afin qu'il prenne en compte la difficultée
        ...
        if(nbrJoueurs == 1){
            ...
            /* Si le joueur décide de jouer à 2, le joueur 2 doit rentrer son numéro souhaitée,
